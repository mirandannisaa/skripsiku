            ...
            <div class="col-lg-12" >
               <div class="card">
                  ...
                  <div class="card-header">
                     <strong>Edit</strong> Tempat Olahraga
                  </div>
                  <div class="card-body card-block">
                  <?php echo form_open_multipart('admin/edittempat'); ?>
                        ...
                        <div class="row form-group">
                           ...
                           <div class="col-12 col-md-9">
                              <input type="text" id="tempat_olahraga" name="tempat_olahraga" placeholder="Tempat Olahraga" class="form-control" value="<?php echo $tempat_list[0]->nama_tempat ?>">
                        ...
                        <div class="row form-group">
                           ...
                           <div class="col-12 col-md-9">
                              <input type="text" id="alamat" name="alamat" placeholder="Alamat" class="form-control" value="<?php echo $tempat_list[0]->alamat ?>">
                        ...
                        <div class="row form-group">
                           ...
                           <div class="col-12 col-md-9">
                              <input type="text" id="kecamatan" name="kecamatan" placeholder="Kecamatan" class="form-control" value="<?php echo $tempat_list[0]->kecamatan ?>">
                        ...
                        <div class="row form-group">
                           ...
                           <div class="col-12 col-md-9">
                              <input type="text" id="no_telp" name="no_telp" placeholder="Nomor Telepon" class="form-control" value="<?php echo $tempat_list[0]->no_telp ?>">
                        ...
                        <div class="row form-group">
                           ...
                           <div class="col-12 col-md-9">
                              <input type="text" id="harga" name="harga" placeholder="Harga" class="form-control" value="<?php echo $tempat_list[0]->harga ?>">
                        ...
                        <div class="row form-group">
                           ...
                           <div class="col-12 col-md-9">
                              <input type="text" id="harga" name="harga" placeholder="Hari Buka" class="form-control" value="<?php echo $tempat_list[0]->hari_buka ?>">
                        ...
                        <div class="row form-group">
                           ...
                           <div class="col-12 col-md-9">
                              <input type="text" id="jam_buka" name="jam_buka" placeholder="Jam Buka" class="form-control" value="<?php echo $tempat_list[0]->jam_buka ?>">
                        ...
                        <div class="row form-group">
                           ...
                           <div class="col-12 col-md-9">
                              <input type="text" id="jam_tutup" name="jam_tutup" placeholder="Jam Tutup" class="form-control" value="<?php echo $tempat_list[0]->jam_tutup ?>">
                        ...
                        <div class="row form-group">
                           ...
                           <div class="col-12 col-md-9">
                              <input type="text" id="latitude" name="latitude" placeholder="Latitude" class="form-control" value="<?php echo $tempat_list[0]->latitude ?>">
                        ...
                        <div class="row form-group">
                           ...
                           <div class="col-12 col-md-9">
                              <input type="text" id="longitude" name="longitude" placeholder="Longitude" class="form-control" value="<?php echo $tempat_list[0]->longitude ?>">
