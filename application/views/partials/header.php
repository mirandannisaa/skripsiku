...
<!-- Datatable -->
<link rel="stylesheet" href="<?php echo base_url(''); ?>/assetdb/assets/css/cs-skin-elastic.css">
<link rel="stylesheet" href="<?php echo base_url(''); ?>/assetdb/assets/css/lib/datatable/dataTables.bootstrap.min.css">
<link rel="stylesheet" href="<?php echo base_url(''); ?>/assetdb/assets/css/style.css">
...
<div class="super_container">
	...
	<header class="header">
		...
		<div class="header_content d-flex flex-row align-items-center justify-content-start">
			...
			<!-- Logo -->
			<div style="height:80px;width:300px"><img src="<?php echo base_url(''); ?>/asset/images/logologo.png"></div>
			...
			<div class="header_right d-flex flex-row align-items-center justify-content-start ml-auto">
				<nav class="main_nav">
					<ul class="d-flex flex-row align-items-center justify-content-start">
						...
						<li><a href="<?php echo base_url('olahraga')?>">Tempat Olahraga</a></li>
					</ul>
				</nav>
				<div class="log_reg">
					<ul class="d-flex flex-row align-items-center justify-content-start">
