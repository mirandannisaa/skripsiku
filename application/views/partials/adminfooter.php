...
<footer class="footer container_custom" style="z-index:1;">
    <div class="column-xs-12">
        <p class="copyright order-md-1 order-2">
            <center>Copyright &copy; 2019 All rights reserved | This template is made with <i class="fa fa-heart-o" aria-hidden="true"></i> by <a>mirandannisaa</a></center>
        </p>
    </div>
</footer>
...
<script src="<?php echo base_url(''); ?>asset/plugins/OwlCarousel2-2.3.4/owl.carousel.js"></script>
...
<script src="<?php echo base_url(''); ?>asset/plugins/colorbox/jquery.colorbox-min.js"></script>
<script src="<?php echo base_url(''); ?>asset/js/custom.js"></script>

<script src="<?php echo base_url(''); ?>asset/js/blog.js"></script>